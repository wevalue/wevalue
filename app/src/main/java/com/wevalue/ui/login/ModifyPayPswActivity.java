 ...
 * 设置新密码界面
 */
public class ModifyPayPswActivity extends BaseActivity implements OnClickListener, WZHttpListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_new_pay_psw);
    ...
    private void modifyPsw() {
        ...
        if (!et_psw_2.getText().toString().trim().equals(psw)) {
            ShowUtil.showToast(ModifyPayPswActivity.this, "您两次输入的密码不一样!");
            return;
        }
...
//				params.put("oldpwd", old_psw);
            ...
            case "3"://修改支付密码
                if(psw.length()<5){
                    ShowUtil.showToast(ModifyPayPswActivity.this, "请设置六位的支付密码!");
                    return;
                }
                map.put("userid", SharedPreferencesUtil.getUid(this));
                map.put("oldpwd", old_psw);
    ...
    public void onSuccess(String content, String isUrl) {
        try {
            ...
            if (obj.getString("result").equals("1")) {
                ShowUtil.showToast(ModifyPayPswActivity.this, obj.getString("message"));
                finish();
            } else {
                ShowUtil.showToast(ModifyPayPswActivity.this, obj.getString("message"));
            }
    ...
    public void onFailure(String content) {
        ShowUtil.showToast(ModifyPayPswActivity.this, content);
    }
}
