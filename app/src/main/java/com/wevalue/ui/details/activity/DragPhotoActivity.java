...
import com.wevalue.view.DragPhotoView;
...
//            Glide.with(this).load(RequestPath.SERVER_PATH + mImgUrl[0]).placeholder(R.mipmap.default_head).into(mPhotoViews[i]);
            mPhotoViews[i].setImageResource(R.mipmap.welcome1);
