...
public class UpdateManager {
    ...
    private void showNoticeDialog() {
        ...
        builder.setMessage("有新版本" + serverVersion + ",请及时更新下载");
    ...
    private Runnable mdownApkRunnable = new Runnable() {
        ...
        public void run() {
            try {
                String apkUrl = SharedPreferencesUtil.getApppath(mContext);
                ...
                savePath = Environment.getExternalStorageDirectory() + "/微值/updateapk/";
                File file = new File(savePath);
                if (!file.exists()) {
                    file.mkdir();
                }
                saveFileName = savePath + "wevalue.apk";
