...
//通讯录和消息页的适配器
public class SortAdapter_2 extends BaseAdapter implements SectionIndexer {
...
//    }
    ...
    public SortAdapter_2(Context mContext, List<SortModel> list, FriendManagerInterface friendManagerInterface) {
        this.mContext = mContext;
        this.list = list;
        this.mFriendManagerInterface = friendManagerInterface;
        mSortType = "contact";
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_contact_2, null);
        ...
        switch (mSortType) {
            ...
            case "contact":
                ...
                if (mContent.getIsFriend().equals("1")) {
                    relation = "(好友)";
                    viewHolder.tv_cancel_attention.setVisibility(View.INVISIBLE);
                    ...
                    if ("3".equals(mContent.getIsFriend()) || "2".equals(mContent.getIsFriend())) {
                ...
                SpannableStringBuilder style_2 = new SpannableStringBuilder(mContent.getUserlevel() + " " + relation);
                style_2.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.blue)), 0,
                        mContent.getUserlevel().length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                viewHolder.tv_level.setText(style_2);
//                viewHolder.tv_cancel_attention.setText("加关注");
                ...
                viewHolder.tv_add_friends.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (finalViewHolder1.tv_add_friends.getText().toString().equals("申请中")) {
                            return;
                        }
                ...
                viewHolder.tv_cancel_attention.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mContent.getIsFocuse().equals("1")) {
