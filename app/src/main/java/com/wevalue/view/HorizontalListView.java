...
public class HorizontalListView extends AdapterView {
	...
	public void setSelection(int position) {
		...
		int maxWidth = (int) (this.getWidth()/3.3*position) ;
		scrollTo(maxWidth);
	}
	...
	private void fillListRight(int rightEdge, final int dx) {
		...
		while (rightEdge + dx < getWidth() &&
			...
			View child =
				mAdapter.getView(
					mRightViewIndex, (View) mRemovedViewQueue.poll(), this);
	...
	private void fillListLeft(int leftEdge, final int dx) {
		...
		while (leftEdge + dx > 0 && mLeftViewIndex >= 0) {
			View child =
				mAdapter.getView(mLeftViewIndex, (View) mRemovedViewQueue.poll(), this);
	...
	private void positionItems(final int dx) {
		...
		if (getChildCount() > 0) {
			...
			for (int i = 0; i < getChildCount(); i++) {
				...
				child.layout(
					left, 0, left + childWidth, child.getMeasuredHeight());
	...
	private OnGestureListener mOnGesture =
		new GestureDetector.SimpleOnGestureListener() {
			...
			public boolean onFling(
				...
				return HorizontalListView.this.onFling(
