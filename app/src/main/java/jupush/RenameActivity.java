...
//
//
//public class RenameActivity extends InstrumentedActivity implements OnClickListener{
//
...
//			break;
//		case R.id.setting:
////			Intent intent = news Intent(RenameActivity.this, PushSetActivity.class);
...
//		mMessageReceiver = news MessageReceiver();
//		IntentFilter filter = news IntentFilter();
...
//              StringBuilder showMsg = news StringBuilder();
