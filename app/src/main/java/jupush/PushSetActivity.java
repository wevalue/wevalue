...
//			Intent intent = news Intent(PushSetActivity.this, SettingActivity.class);
...
//		Set<String> tagSet = news LinkedHashSet<String>();
...
//		BasicPushNotificationBuilder builder = news BasicPushNotificationBuilder(PushSetActivity.this);
...
//		CustomPushNotificationBuilder builder = news CustomPushNotificationBuilder(PushSetActivity.this,R.layout.customer_notitfication_layout,R.id.icon, R.id.title, R.id.text);
...
//
//
//	private final TagAliasCallback mAliasCallback = news TagAliasCallback() {
//
//        @Override
...
//	};
//
//    private final TagAliasCallback mTagsCallback = news TagAliasCallback() {
//
//        @Override
//        public void gotResult(int code, String alias, Set<String> tags) {
//            String logs ;
...
//
//
//    private final Handler mHandler = news Handler() {
//        @Override
