...
# in J:\android-sdk-windows/tools/proguard/proguard-android.txt
...
#下面中括号的地方需要要填你的包名
-keep public class [com.wevalue].R$*{
...
-keep class com.a.a.**  {*;}
#---------------------------------反射相关的类和方法-----------------------在这下面写反射相关的类和方法，没有就不用写！




#---------------------------------与js互相调用的类------------------------在这下面写与js互相调用的类，没有就去掉这句话！

#---------------------------------自定义View的类------------------------在这下面写自定义View的类的类，没有就去掉这句话！
-keep class [com.wevalue.view].** { *; }
...
#保留引用类库
-keep class com.jungly.gridpasswordview.** {*;}
-keep class com.bigkoo.pickerview.** {*;}
-keep class sz.itguy.wxlikevideo.** {*;}
-keep class com.handmark.pulltorefresh.library.** {*;}
