...
public class WXLikeVideoRecorder implements Camera.PreviewCallback, CameraPreviewView.PreviewEventListener {
    private static final int audioException = 267;
    Handler handler;
    ...
    public WXLikeVideoRecorder(Context context, String folder, Handler handler) {
        mContext = context;
        mFolder = folder;
    ...
    private void initRecorder() {
        ...
        Log.e("log-", "RECORD_LENGTH RECORD_LENGTH RECORD_LENGTH-----" + RECORD_LENGTH);
...
//        recorder = new FFmpegFrameRecorder(strFinalPath, imageWidth, imageHeight, 1);
        ...
        Log.e("log-", "FRAME_RATE FRAME_RATE FRAME_RATE-----" + FRAME_RATE);
...
//    }
    ...
    private void initFrameFilter() {
        ...
        Log.e("log-", " mFilters  =" + mFilters);
        mFrameFilter = new FFmpegFrameFilter(mFilters, imageWidth, imageHeight);
        mFrameFilter.setPixelFormat(org.bytedeco.javacpp.avutil.AV_PIX_FMT_NV12); // default camera format on Android
    }
...
//                return;
//            }
//            Log.e("log-","sssssss="+RECORD_LENGTH);
            if (RECORD_LENGTH > 0) {
    ...
    class AudioRecordRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.d(TAG, "audioRecord.startRecording()" + audioRecord.getState());
