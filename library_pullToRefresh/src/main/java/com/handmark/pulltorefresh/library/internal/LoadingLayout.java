...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	private CharSequence mReleaseOkLabel;
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			...
			default:
				...
				mReleaseOkLabel=context.getString(R.string.pull_to_refresh_refreshing_ok_label);
				break;
		}
	...
	public final void refreshing() {
		...
		if (null != mHeaderPullDownImageView) {
			mHeaderPullDownImageView.setVisibility(View.GONE);
		}
	}
	...
	public void setReleaseOkLabel(CharSequence releaseOkLabel) {
		mReleaseOkLabel = releaseOkLabel;
	}
